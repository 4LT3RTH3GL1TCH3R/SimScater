...
def main():
    ...
    print("[*] Obfuscating with 3 layers, 2x noise, 200-char/byte...")
    start = time.time()
    result = recursive_obfuscate(code, charset, layers=3, noise_ratio=2, char_per_byte=200)
