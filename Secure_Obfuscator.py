...
def main():
    ...
    print("[*] Obfuscating with 10 layers, 5x noise, 500-char/byte...")
    start = time.time()
    result = recursive_obfuscate(code, charset, layers=10, noise_ratio=5, char_per_byte=500)
