...
def main():
    ...
    print("[*] Obfuscating with 1 layers, 1x noise, 100-char/byte...")
    start = time.time()
    result = recursive_obfuscate(code, charset, layers=1, noise_ratio=1, char_per_byte=100)
